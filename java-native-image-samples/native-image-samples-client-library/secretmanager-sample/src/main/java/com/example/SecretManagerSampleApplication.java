...
public class SecretManagerSampleApplication {
  ...
  private static final String NATIVE_IMAGE_TEST_SECRET_ID = "native-secretmanager-test-secret";
  ...
  public static void main(String[] args) throws IOException {
    ...
    try (SecretManagerServiceClient client = SecretManagerServiceClient.create()) {
      if (!hasSecret(client, projectId, NATIVE_IMAGE_TEST_SECRET_ID)) {
        createSecret(client, projectId, NATIVE_IMAGE_TEST_SECRET_ID);
      } else {
        System.out.println("Project already has secret: " + NATIVE_IMAGE_TEST_SECRET_ID);
      }

      SecretVersion version = addSecretVersion(client, projectId, NATIVE_IMAGE_TEST_SECRET_ID);
