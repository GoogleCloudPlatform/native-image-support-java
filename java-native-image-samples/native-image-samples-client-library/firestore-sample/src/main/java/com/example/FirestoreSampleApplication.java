...
public class FirestoreSampleApplication {
  ...
  private static final String USERS_COLLECTION = "native_imagetest_users";
  ...
  private static void deleteCollection(Firestore db) throws Exception {
  ...
  private static void runSampleQueries(Firestore db) throws Exception {
