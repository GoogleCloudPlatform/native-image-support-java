...
public class BigQuerySampleApplication {
  ...
  private static final String DATASET_ID = "native_imagetest_dataset";

  private static final String TABLE_ID = "native_imagetest_table";
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    insertTestRecord(bigQuery, DATASET_ID, tableName);
  ...
  private static void insertTestRecord(
    ...
    rowContent.put("id", "TestUser-" + UUID.randomUUID().toString());
    rowContent.put("age", 40);
  ...
  private static void createDataset(BigQuery bigQuery, String datasetName) {
    DatasetInfo datasetInfo = DatasetInfo.newBuilder(datasetName).build();
    Dataset newDataset = bigQuery.create(datasetInfo);
    System.out.println("Created new dataset: " + newDataset.getDatasetId().getDataset());
  }

  private static boolean hasDataset(BigQuery bigQuery, String datasetName) {
  ...
  private static void deleteTable(BigQuery bigQuery, String datasetName, String tableName) {
    bigQuery.getTable(datasetName, tableName).delete();
    System.out.println("Deleted table: " + tableName);
  }

  private static void deleteDataset(BigQuery bigQuery, String datasetName) {
