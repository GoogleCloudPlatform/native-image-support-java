...
You may skip the Native Image installation step if you would like to build the executable in a container.
...
If you don't have Native Image installed, you can run the native executable build in a container using the following command.
