...
/**
 * Sample application demonstrating GraalVM compatibility with Google Cloud Secret Manager APIs.
 */
public class SecretManagerSampleApplication {

  private static final String GRAALVM_TEST_SECRET_ID = "graal-secretmanager-test-secret";
